...
if contM1 > contM2 and contM1 > contM3 and contM1 > contM4:
    print(f"Momentos con mayor cantidad de viajes son: 1:{contM1}")
if contM2 > contM1 and contM2 > contM3 and contM2 > contM4:
    print(f"Momentos con mayor cantidad de viajes son: 2:{contM2}")
if contM3 > contM2 and contM3 > contM1 and contM3 > contM4:
    print(f"Momentos con mayor cantidad de viajes son: 3:{contM3}")
if contM4 > contM2 and contM4 > contM3 and contM4 > contM1:
    print(f"Momentos con mayor cantidad de viajes son: 4:{contM4}")
if contM1 >= contM2 >= contM3 >= contM4:
    print(f"Momentos con mayor cantidad de viajes son: 1:{contM1}, 2:{contM2}, 3:{contM3}, 4:{contM4}")
